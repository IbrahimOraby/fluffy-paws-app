...
export default function Services() {
  const servicesData = [
    ...
    },
    {
      ...
      description:
        "Your sitter will stay overnight with your pet at your home, ensuring comfort and companionship throughout the night.",
      icon: <MoonIcon />,
    },
    {
      title: "Feeding & Medication",
      description:
        "We make sure your pet is well-fed and gets their medications on time, exactly as instructed.",
      icon: <MedicalIcon />,
    },
    {
      title: "Shelter Boarding",
      description:
        "Trusted shelter care for your pet when you're away. Affordable, safe, and monitored by professionals. Perfect for extended trips or emergencies",
      icon: <StaticBuildingIcon color="#be5985" />,
    },
    {
      title: "Last-Minute Booking",
      description:
        "Unexpected plans? No worries! Find trusted sitters available on short notice for emergencies or sudden trips.",
