          ...
          <div className="flex-1">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-4">
              <Animalcard
                ...
                className="w-full sm:w-1/2 border border-gray-300 hover:border-gray-500 transition-all duration-200 rounded-md shadow-sm cursor-pointer"
              />
              <Animalcard
        ...
        <div className="absolute top-[350px] left-1/2 transform -translate-x-1/2 bg-[#f4f4f4] rounded-xl p-6 shadow-lg w-[95%] max-w-5xl z-10">
          <form className="flex flex-col gap-6">
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-col sm:flex-row gap-4 mt-4">
                  <Animalcard
                    ...
                    title={'Dogs'}
                    description={'Including puppys'}
                    className="w-full sm:w-1/2 border border-gray-300 hover:border-gray-500 transition-all duration-200 rounded-md shadow-sm cursor-pointer pt-5 pb-6"
                  />
                  <Animalcard
                    icon={<StaticCatIcon color="#BE5985" />}
                    title={'Cats'}
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-col sm:flex-row gap-4 mt-4">
                  <Animalcard
                    ...
                    title={'Personal Carer'}
                    description={'Cheaper prices'}
                    className="w-full sm:w-1/2 border border-gray-300 hover:border-gray-500 transition-all duration-200 rounded-md shadow-sm cursor-pointer p-5"
                  />
                  <Animalcard
                    icon={<HomeIcon color="#BE5985" />}
                    title={'Organization'}
                    description={'See our trusted partners'}
                    className="w-full sm:w-1/2 border border-gray-300 hover:border-gray-500 transition-all duration-200 rounded-md shadow-sm cursor-pointer p-3"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center gap-4">
              <div className=" flex-row md:flex-row gap-3 flex-1">
                <IconPlaceholderInput
                  icon={<StaticMapIcon />}
                  placeholder="Add your street address"
                  width="w-full md:w-[70%]"
                />
                <CalendarInput placeholder={'Choose the date'} className="w-full md:w-[30%]" />
              </div>

              <button
                className="flex items-center justify-center gap-2 px-6 py-3 text-sm text-white rounded-full shadow-sm hover:shadow-md transition duration-200 hover:opacity-90 w-full md:w-auto"
                style={{ backgroundColor: '#BE5985' }}
              >
                <SearchIcon className="w-4 h-4" />
                Search for a sitter
